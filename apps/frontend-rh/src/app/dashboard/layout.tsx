...
const NAV = [
  ...
  { href: "/dashboard/attendance", label: "Presença", icon: "📅" },
  { href: "/dashboard/wellbeing", label: "Bem-Estar", icon: "🌡️" },
] as const;
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      <aside className="w-56 flex flex-col bg-white border-r border-gray-200">
        <div className="flex items-center h-16 px-5 border-b border-gray-200">
          <span className="text-lg font-bold text-teal-600">VULTRA</span>
          <span className="ml-2 text-xs font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded">RH</span>
        </div>
